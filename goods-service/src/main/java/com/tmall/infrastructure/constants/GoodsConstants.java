...
public class GoodsConstants {
	...
	public static final int CATEGORY_STATUS_UNFINISHED = 0;
	public static final int CATEGORY_STATUS_FINISHED = 1;
	public static final int CATEGORY_STATUS_TEMPORY = 2;

	/**类别根目录ID*/
	public static final int CATEGORY_ROOT_ID = 0;

	/**商品状态(0:违规 1:未审核 2:已审核)*/
	public static final int GOODS_STATUS_VIOLATION = 0;
	public static final int GOODS_STATUS_UNREVIEWED = 1;
	public static final int GOODS_STATUS_REVIEWED = 2;
}
