...
(function() {
	...
	CKEDITOR.plugins.add('ysLineHeight', {
	    lang: ['ja'],
		requires: ['richcombo'],

		init: function(editor) {
			var config = editor.config;
			addCombo(editor, 'ysLineHeight', 'size', editor.lang.ysLineHeight, config.ysLineHeight_sizes, config.fontSize_defaultLabel, config.ysLineHeight_style);
		}
	});
...
CKEDITOR.config.ysLineHeight_sizes = 
	'100%;120%;130%;150%;170%;180%;190%;200%;220%;250%;300%;400%;500%';

CKEDITOR.config.ysLineHeight_style = {
		element  : 'span',
